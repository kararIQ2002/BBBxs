...
--32 menu
function CHOME32()
  BIT32 = gg.alert("➧ʙ𝐁ʙ: ʜɪ ᴜsᴇʀ ᴛʜɪs sᴄʀɪᴘᴛ ɪs ғʀᴇᴇ ʜᴏᴘɪɴɢ ʏᴏᴜ ᴇɴᴊᴏʏ ɪᴛ♥️ \n\n➧ɢᴀᴍᴇ: ᴘᴜʙɢᴍᴏʙɪʟᴇ 🍭\n➧ʙɪᴛ: 32⚙\n➧ᴄʀᴇᴀᴛᴏʀ: باربي✞ ᴋᴀʀᴀʀ( ✘_✘ )↯ 🖤 \n\n®2020 𝓑𝓑𝓑 - ᴀʟʟ ʀɪɢʜᴛᴇs ʀᴇsᴇʀᴠᴇᴅ.", "⟬ ﷼  🇮🇶 ⟭", "⟬ 𝐄𝐧 🇺🇸 ⟭")
if BIT32 == nil then
  else
    if BIT32 == 1 then
...
--64 menu
function CHOME64()
  BIT64 = gg.alert("➧ʙ𝐁ʙ: ʜɪ ᴜsᴇʀ ᴛʜɪs sᴄʀɪᴘᴛ ɪs ғʀᴇᴇ ʜᴏᴘɪɴɢ ʏᴏᴜ ᴇɴᴊᴏʏ ɪᴛ🎟\n\n➧ɢᴀᴍᴇ: ᴘᴜʙɢᴍᴏʙɪʟᴇ 🧨\n➧ʙɪᴛ: 64⚙\n➧ᴄʀᴇᴀᴛᴏʀ: باربي✞ ᴋᴀʀᴀʀ( ✘_✘ )↯ ♥️\n\n®2020 𝓑𝓑𝓑 - ᴀʟʟ ʀɪɢʜᴛᴇs ʀᴇsᴇʀᴠᴇᴅ.", "⟬ ﷼  🇮🇶 ⟭", "⟬ 𝐄𝐧 🇺🇸 ⟭")
if BIT64 == nil then
  else
    if BIT64 == 1 then
    if gg.getTargetPackage() == "com.tencent.ig" or gg.getTargetPackage() == "com.rekoo.pubgm" or gg.getTargetPackage() == "com.tencent.tmgp.pubgmhd" or gg.getTargetPackage() == "com.pubg.krmobile" or gg.getTargetPackage() == "com.vng.pubgmobile" then
...
"📁🍋ᴡʜ+ᴄᴏʟᴏʀ\n ᯓ『 ɢᴀᴍᴇ 』",
"🍺ғʟᴀsʜ2500ᴍ\n ᯓ『 ɢᴀᴍᴇ|ʟᴏʙʙʏ 』"..para,
" ❌❌❌❌⌬ ᴇxɪᴛ🚫🚫🚫🚫"},nil,"ʙ𝐁ʙ➧ᴍᴀɪɴ ᴍᴇɴᴜᯓ 64 ʙɪᴛ 🍉")
...
"📁🍋وايل هاك\n 『 قيم 』",
"🍺فلاش2500م\n 『 قيم|لوبي 』"..para,
" ❌❌❌❌⌬ خروح🚫🚫🚫🚫"},nil,"ʙ𝐁ʙ➧قائمه رئيسية نسخة 64 بت🍉")
if menu==1 then A()end
...
gg.toast("🌒رجاء جرب")
gg.sleep(300)
gg.toast("🌓رجاء جرب الكود")
gg.sleep(300)
gg.toast("🌔رجاء جرب الكود بالقست")
gg.sleep(200)
gg.toast("🌕رجاء جرب الكود بالقست اول")
end
...
"⚪ᴡʜɪᴛᴇ",
"🏖ɴᴏ ғᴏɢ",
"↶ ᴇxɪᴛ"},nil,"ʙ𝐁ʙ➧ʟᴏʙʙʏ|ɢᴀᴍᴇ ᴍᴇɴᴜᯓ 64 ʙɪᴛ🍿")
if menu1 == nil then
 else
...
"⚪لون ابيض",
"🏖ازالة الضباب",
"↶ رجوع"},nil,"ʙ𝐁ʙ➧لوبي|قيم قائمة نسخة 64🍿")
if menu1 == nil then
 else
if menu1[1] == true then hlobby() end
if menu1[2] == true then bC1() end
...
"⛱ғʟʏɪɴɢ sɪᴛ",
"🎐ʟᴏɴɢ ᴘᴀʀᴀᴄʜᴜᴛᴇ",
"↶ ᴇxɪᴛ"},nil,"ʙ𝐁ʙ➧ɢᴀᴍᴇ ᴍᴇɴᴜᯓ 64 ʙɪᴛ 🍿")
if menu1 == nil then
 else
...
"⛱اكعد و اتفرج",
"🎐برشوت قدااام",
"↶ رجوع"},nil,"ʙ𝐁ʙ➧قيم قائمة نسخة 64🍿")
if menu1 == nil then
 else
...
"🍺فلاش2500م\n 『 قيم|لوبي 』"..para,
"🔧ترسيت سريع",
" ❌❌❌❌⌬ خروح🚫🚫🚫🚫"},nil,"ʙ𝐁ʙ➧قائمه رئيسية نسخة 32 بت🍉")
if menu==1 then A()end
...
"🥳ᴀɪᴍʟᴏᴄᴋ³⁰",
"🏖ɴᴏ ғᴏɢ",
"↶ ᴇxɪᴛ"},nil,"ʙ𝐁ʙ➧ʟᴏʙʙʏ|ɢᴀᴍᴇ ᴍᴇɴᴜᯓ 32 ʙɪᴛ 🍿")
if menu1 == nil then
 else
 if menu1[1] == true then hlobby() end
if menu1[2] == true then bC1() end
...
"🥳ايم لوك",
"🏖ازالة الضباب",
"↶ رجوع"},nil,"ʙ𝐁ʙ➧لوبي|قيم قائمة نسخة 32🍿")
if menu1 == nil then
 else
 if menu1[1] == true then hlobby() end
if menu1[2] == true then bC1() end
...
"⛱ғʟʏɪɴɢ sɪᴛ",
"🎐ʟᴏɴɢ ᴘᴀʀᴀᴄʜᴜᴛᴇ",
"↶ ᴇxɪᴛ"},nil,"ʙ𝐁ʙ➧ɢᴀᴍᴇ ᴍᴇɴᴜᯓ 32 ʙɪᴛ 🍿")
if menu1 == nil then
 else
...
"⛱اكعد و اتفرج",
"🎐برشوت قدااام",
"↶ رجوع"},nil,"ʙ𝐁ʙ➧قيم قائمة نسخة 32🍿")
if menu1 == nil then
 else
